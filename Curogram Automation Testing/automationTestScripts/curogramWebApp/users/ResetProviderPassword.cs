    ...
    internal class ResetProviderPassword
    {
        ...
        public async Task RestUserPassword()
        {
            ...
            try
            {
                ...
                //generate email variable
                Random rand = new Random();
                var emailString = new string(Enumerable.Repeat("abcdefghijklmnopqrstuvwxyz0123456789", 9)
                    .Select(s => s[rand.Next(s.Length)]).ToArray());
                var email = emailString + "@mailsac.com";

                //generate patient first name and last name
                var firstName = new string(Enumerable.Repeat("abcdefghijklmnopqrstuvwxyz0123456789", 9)
                .Select(s => s[rand.Next(s.Length)]).ToArray());
                var lastName = new string(Enumerable.Repeat("abcdefghijklmnopqrstuvwxyz0123456789", 9)
                .Select(s => s[rand.Next(s.Length)]).ToArray());
                ...
                js.ExecuteScript("arguments[0].value = '" + emailString + "';", emailInputField);
                ...
                js.ExecuteScript("arguments[0].value = '" + "" + email + "" + "';", emailResetInputField);
                ...
                js.ExecuteScript("arguments[0].value = '" + "" + newPassword + "" + "';", ResetPasswordInputField);
