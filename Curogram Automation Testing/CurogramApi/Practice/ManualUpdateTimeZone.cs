        ...
        public async Task<HttpResponseMessage> UpdateTimeZone(string authToken, string practiceName, string timeZone)
        {
            ...
            using (var httpClient = new HttpClient(handler))
            {
                using (var request = new HttpRequestMessage(new HttpMethod("PUT"), "https://api-v2.staging.curogram.com/practices/settings"))
                {
                    ...
                    request.Content = new StringContent("{\"name\":\""+ practiceName + "\",\"timezone\":\""+ timeZone + "\"}");
...
/* Use this to call this method in a different class
        ...
        public async Task TimeZone()
        {
            ...
            var response = await new ManualUpdateTimeZone().UpdateTimeZone(authToken, practiceName, timeZone);
...
/* API link
 * https://api-v2.dev.curogram.com/apidoc/static/index.html#/Practices/PracticeController_updatePracticeInfoById
 */